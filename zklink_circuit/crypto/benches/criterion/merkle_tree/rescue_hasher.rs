...
use zklink_crypto::merkle_tree::{hasher::Hasher, RescueHasher};
use zklink_crypto::Engine;

const SMALL_INPUT_SIZE: usize = 16; // 16 bits / 2 bytes
const BIG_INPUT_SIZE: usize = zklink_crypto::params::MAX_CIRCUIT_MSG_HASH_BITS; // Biggest supported size.
