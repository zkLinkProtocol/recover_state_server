...
use zklink_crypto::ff::PrimeField;
use zklink_crypto::merkle_tree::{parallel_smt::SparseMerkleTree, RescueHasher};
...
fn smt_create(b: &mut Bencher<'_>) {
    let depth = zklink_crypto::params::account_tree_depth();
